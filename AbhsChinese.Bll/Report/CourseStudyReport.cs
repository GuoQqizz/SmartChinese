...
{
    public class CourseStudyReport : ReportSubscribeBase
    {
        public CourseStudyReport(string msg) : base(msg)
        {
        }

        public override void Handle()
        {
            CourseStudyMessage msgObject = JsonConvert.DeserializeObject<CourseStudyMessage>(message);
