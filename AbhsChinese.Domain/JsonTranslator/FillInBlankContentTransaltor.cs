...
{
    public class FillInBlankContentTransaltor : ITranslator<Yw_SubjectContent, Yw_FillInBlankContent>
    {
        public Yw_FillInBlankContent MakeTranslator(Yw_SubjectContent entity)
        {
            Yw_FillInBlankContent realEntity = new Yw_FillInBlankContent();
            ...
            {
                realEntity.Ysc_Content_Obj = JsonConvert.DeserializeObject<FillInBlankContentObj>(entity.Ysc_Content);
            }
            if (!string.IsNullOrEmpty(entity.Ysc_Answer))
            {
                realEntity.Ysc_Answer_Obj = JsonConvert.DeserializeObject<FillInBlankAnswerObj>(entity.Ysc_Answer);
            }
            return realEntity;
        }
    }
