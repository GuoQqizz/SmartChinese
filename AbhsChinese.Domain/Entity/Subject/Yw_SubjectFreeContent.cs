...
{
    public class Yw_SubjectFreeContent : Yw_SubjectContent, IJsonTranslator
    {
        public SubjectFreeContentObj Ysc_Content_Obj { set; get; }

        public SubjectFreeAnswerObj Ysc_Answer_Obj { set; get; }
