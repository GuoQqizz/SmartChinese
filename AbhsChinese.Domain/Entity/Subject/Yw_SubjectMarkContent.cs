...
{       
    public class Yw_SubjectMarkContent : Yw_SubjectContent, IJsonTranslator
    {
        public SubjectMarkContentObj Ysc_Content_Obj
        {
            set; get;
        }
        public SubjectMarkAnswerObj Ysc_Answer_Obj
        {
            set; get;
        }
